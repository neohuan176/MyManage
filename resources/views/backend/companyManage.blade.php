    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body" id="app">
            ...
            <div class="row">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">公司客户<a type="button" style="font-size: 12px;color: #fff;" class="label label-primary" href="{{url('admin/companyManage?type=1')}}">显示全部</a></h3>
                        <div class="right">
                        </div>
                    </div>
                    <div class="panel-body no-padding">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{url('admin/showOrderByCompany/'.$company->id)}}">查看订单</a>
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#addCompanyPanel" onclick="alterCompany({{$company}},this)">修改信息</button>
                                    <button class="btn btn-primary" onclick="deleteCompany('{{$company->id}}',this)">删除</button>
                                </td>
                            </tr>
                                @endforeach
                            </tbody>
