...
@section('content')
                                ...
                                <tr>
                                    <td>
                                        <label class="fancy-checkbox">
                                            ...
                                            <span><a href="{{route('admin.personal.showClientInfo',[$order->clientId])}}">{{$order->clientInfo->name}}</a></span>
                                        </label>
                                    </td>
                                ...
                                <td>
                                    <label class="fancy-checkbox">
                                        ...
                                        <span>全选 &nbsp; &nbsp;
                                            ...
                                            <a class="btn btn-sm btn-success" href="{{url('admin/orders/exportClientOrders')}}" target="_blank">导出</a>
                                        </span>
                                    </label>
                                </td>
    ...
    <script type="text/javascript">
        ...
        function changeStatus(orderId,t){
            ...
            $.post("{{url('admin/orders/changeOrderStatus/1')}}",
                {
                    isDone: isDone,
                    orderId: orderId
                },
