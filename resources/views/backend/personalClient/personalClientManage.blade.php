...
@section('js-start')
    <script type="text/javascript" src="http://webapi.amap.com/maps?v=1.3&key=243f524bd3274d3a0e201a5625c41593"></script>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger btn-sm" onclick="deleteClient('{{$client->id}}',this)">删除</button>
                                </td>
                            </tr>
                                @endforeach
                            </tbody>
